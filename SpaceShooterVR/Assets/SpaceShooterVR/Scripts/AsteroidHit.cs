...
public class AsteroidHit : MonoBehaviour
{
    ...
    public void AsteroidDestroyed()
    {
        ...
        if(GameController.currentGameStatus == GameController.GameState.Playing)
        {
            ...
            asteroidPopup.transform.localScale = new Vector3(transform.localScale.x * (distanceFromPlayer / 3),
                                                             transform.localScale.y * (distanceFromPlayer / 3),
                                                             transform.localScale.z * (distanceFromPlayer / 3));
